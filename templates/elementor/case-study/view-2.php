                        ...
                        <div class="content-wrap">
                            <div class="content-info">
	                            ...
	                            <?php if( $read_more_display == 'yes' ) { ?>
                                    <div class="rt-button"><a class="btn button-2" <?php echo $attr; ?>><?php echo foodymat_html( $item['button_text'], 'allow_title' );?><?php Icons_Manager::render_icon( $item['list_icon'] ); ?></a></div>
	                            <?php } ?>
                            </div>
                        </div>
                    </div>
