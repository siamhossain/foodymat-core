...
?>
<div class="rt-project-default rt-project-multi-layout-5 project-grid-<?php echo esc_attr( $layout );?> <?php if ( $all_button == 'hide' ) {?>hide-all<?php } ?> rt-isotope-wrapper">
                                ...
                                <?php } if( $button_display ) { ?>
                                    <div class="rt-button">
	                                    <?php if( $link_popup == 'popup' ) { ?>
                                            <a class="btn button-1" href="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>"
